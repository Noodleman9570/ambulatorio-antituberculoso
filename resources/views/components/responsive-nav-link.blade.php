...
$classes = ($active ?? false)
            ? 'block w-full pl-3 pr-4 py-2 border-l-4 border-[#20acb8]400 text-left text-base font-medium text-[#20acb8]700 bg-[#20acb8] focus:outline-none focus:text-[#20acb8] focus:bg-[#20acb8] focus:border-[#20acb8] transition duration-150 ease-in-out'
